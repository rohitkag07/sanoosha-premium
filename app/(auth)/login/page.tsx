    ...
    <div className="bg-white rounded-brand shadow-lg p-8">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          disabled={loading}
          className="mt-6 w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-3 text-sm font-medium text-charcoal hover:bg-gray-50 transition disabled:opacity-60"
        >
